      ...
      <div className="row">
        <div className="col-md-8 mx-auto">
          <p className="lead">
            ...
            terms and conditions of your use of the sokochat.com website and any
          ...
          <p>
            ...
            this Agreement, you are not authorized to use the Website or its
            Services.
          </p>
          ...
          <p>
            ...
            by anyone under 18 years is expressly prohibited. By accessing or
            using the Website or its Services, you represent and warrant that
          ...
          <p>
            ...
            ownership or right to use of all submitted Content. We may monitor
            and review Content on the Website submitted or created using our
            Services by you.
          </p>
          ...
          <p>
            ...
            or any third party should we exercise such right. We reserve the
            right to interrupt the Services with or without notice to you, in
            order to perform maintenance or upgrades, or to resolve any issues
